...
export default function SellerHome() {
    ...
    return (
        <div className="container">
            <div>
                <button className="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded mb-4 mt-4 mr-3 active:bg-blue-900"><Link href="/seller/register">Create a seller account</Link></button>
                <button className="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded mb-4 mt-4 active:bg-blue-900"><Link href="/seller/login">Login</Link></button> 
            </div>
            ...
            Non at libero et adipisci blanditiis dolorem, optio nesciunt dolore ipsum error commodi laborum quisquam, voluptate itaque tempora distinctio officiis unde temporibus, ducimus minus voluptatibus laboriosam amet doloremque! Aspernatur, reprehenderit?
            Autem, possimus placeat corrupti recusandae, ratione voluptatibus nobis alias dignissimos laborum voluptatum assumenda explicabo. Nesciunt consectetur eveniet minima asperiores reprehenderit ullam laborum! Doloremque labore cumque consequatur corrupti nisi quo incidunt.
            Tenetur pariatur quos dignissimos distinctio eos porro. Veniam illo maxime vitae velit autem explicabo itaque neque necessitatibus voluptatum nobis nesciunt laudantium quasi pariatur totam, quisquam quidem suscipit. Qui, labore nam?
            Veniam, saepe, debitis necessitatibus ducimus, quaerat labore iure commodi assumenda quidem natus eum. Voluptates fugiat omnis pariatur deserunt? Illo quod incidunt dolore facere deserunt saepe illum sunt eaque! Voluptatem, alias.
